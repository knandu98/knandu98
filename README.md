...
- **Lakehouse and analytical data architectures** with AWS S3, Parquet, DuckLake, Apache Iceberg, PostgreSQL, SQLite, and DuckDB  
- **Dashboards and visual analytics** using Plotly.js, Power BI, Tableau, Looker, Dash, and Streamlit  
...
- AI Automation & LLM-Based Workflows  
- Manufacturing and Automotive Data Systems  
...
**Backend:** Flask, FastAPI, Node.js, Express.js, NestJS, REST APIs  
**Data:** pandas, PySpark, DuckDB, DuckLake, Apache Iceberg, PostgreSQL, MySQL, BigQuery, dbt  
**Cloud & DevOps:** AWS, GCP, Docker, Kubernetes, OpenShift, GitHub Actions, ArgoCD, Helm, Linux  
...
- Created benchmarking workflows for S3/Parquet, DuckLake, and Apache Iceberg  
- Developed LLM-based knowledge analysis automation for internal documentation  
